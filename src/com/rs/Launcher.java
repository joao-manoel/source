...
import com.rs.webserver.SocketServer;
...
public final class Launcher {
	...
	public static void main(String[] args) throws Exception {
		...
		addCleanMemoryTask();
		Logger.log("SOCKET", "WEBSOCKET CONNECTING...");		
	...
	public static void setWebsitePlayersOnline(int amount) throws IOException {
    	URL url = new URL( "http://site.test/playercount/cfa79762c80569aa5361c6f32b880577/" + amount);
