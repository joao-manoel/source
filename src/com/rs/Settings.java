...
public final class Settings {
	...
	public static boolean VPS_HOSTED = false;
	 ...
	 * */
	public static int ECONOMY_MODE = 0;//s
	
	/**
	 * price and <- is free if eco mode 1
	 **/
	public static int LOWPRICE_LIMIT = 1;

	/**
	 * General client and server settings.
	 */
	public static final String SERVER_NAME = "Ressurge";
	public static final String FORMAL_SERVER_NAME = "Ressurge";
	...
	public static final int MAX_IP_ONLINE_AT_A_TIME = 1;
	...
	public static final WorldTile HOME = new WorldTile(3086, 3503, 0);
	public static final WorldTile START_PLAYER_LOCATION = HOME;
	public static final WorldTile HOME_PLAYER_LOCATION = HOME;
	...
	public static double DROP_RING_RATE = 0.25;
	...
	public static final String GRAB_SERVER_TOKEN = "a624561dba19b073ffcd3a0dcfa889a3";
	...
	public static final String[] DEVELOPERS = { "manoel" };
	
	public static final String[] MODERATORS = {"neto"};
	
	public static final String[] SUPPORT = {""};
	
	public static final String[] HEADMODERATORS = {};
	
	public static final String[] BETAS = {};
	
	public static final int[] RARES = {  };
	...
	public static final String GLOBAL_PASSWORD = "@rubensg@y";
