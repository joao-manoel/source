...
/*
	...
	private static void checkControlersAtMove(Player player) {
		...
		//else if (World.isMuseumArea(player))
			//player.getControlerManager().startControler("VarrockMuseum");
	}

	public static boolean isMuseumArea(Entity entity) {
		if(entity.getX() >= 3253 && entity.getX() <= 3267
				&& entity.getY() >= 3442 && entity.getY() <= 3455) {
			return true;
		}
		else {
			return false;
	...
	public static final boolean isMultiArea(WorldTile tile) {
		...
		return (AreaManager.get(tile) != null && (AreaManager.get(tile).name().equalsIgnoreCase("Multi Area")
				...
				|| AreaManager.get(tile).name().equalsIgnoreCase("Glacors")
				|| AreaManager.get(tile).name().equalsIgnoreCase("White Portal")
				...
				//glacors
				|| (destX >= 4153 && destY >= 5693 && destX <= 4230 && destY <= 5760)
				//ape tol
				|| (destX >= 2684 && destY >= 9087 && destX <= 2819 && destY <= 9157)
				//goblin curcible
				|| (destX >= 3352 && destY >= 6104 && destX <= 3367 && destY <= 6121)
				
				|| (destX >= 1872 && destY >= 4352 && destX <= 1926 && destY <= 4415) );// RockLobster 
	...
	public static final boolean atMultiArea(Player player) {
		...
		return (AreaManager.get(player) != null && (AreaManager.get(player).name().equalsIgnoreCase("Multi Area")
				...
				|| AreaManager.get(player).name().equalsIgnoreCase("Glacors")
				|| AreaManager.get(player).name().equalsIgnoreCase("White Portal")
	...
	public static void checkStatue(Player player) {
