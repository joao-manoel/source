...
public final class MobRewardGenerator {
	...
	private int VERY_RARE = 990;//994 0.6%
	private int RARE = 970;//976 2.4%
	...
	public int generateRarityNode(Player player) {
		...
		final int row = ItemDefinitions.getItemDefinitions(player.getEquipment().getRingId()).getName().toLowerCase().contains("ring of wealth") ? 50 : 0;
