...
import com.rs.game.player.controlers.varrockmuseum.VarrockMuseum;
...
public class ControlerHandler {
	...
	public static final void init() {
		try {
			...
			handledControlers.put("DeathEvent", 
					(Class<Controler>) Class.forName(DeathEvent.class.getCanonicalName()));
			...
			handledControlers.put("VarrockMuseum",
