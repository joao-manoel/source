...
public class RunespanControler extends Controler {
	...
	public void exitRunespan() {
		handlePoints();
		player.setRunespanPoints(getRunespanInventoryPoints());
		player.getInterfaceManager().closeOverlay(false);
		final int RUNE_ESSENCE = 24227,
				AIR_RUNE = 24215, MIND_RUNE = 24217, WATER_RUNE = 24214,
				BODY_RUNE = 24218, EARTH_RUNE = 24216, FIRE_RUNE = 24213,
				COSMIC_RUNE = 24223, NATURE_RUNE = 24220, CHAOS_RUNE = 24221,
				LAW_RUNE = 24222, DEATH_RUNE = 24219, BLOOD_RUNE = 24225,
				SOUL_RUNE = 24226, ASTRAL_RUNE = 24224;
		player.getInventory().deleteItem(RUNE_ESSENCE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(AIR_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(MIND_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(WATER_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(EARTH_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(LAW_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(DEATH_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(BLOOD_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(SOUL_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(FIRE_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(BODY_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(NATURE_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(CHAOS_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(COSMIC_RUNE, Integer.MAX_VALUE);
		player.getInventory().deleteItem(ASTRAL_RUNE, Integer.MAX_VALUE);
		removeControler();
	}
	...
	public void sendInterfaces() {
		...
		player.getPackets().sendIComponentText(1274, 5, Integer.toString(player.getmainrspoints()));
