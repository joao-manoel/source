												...
												RARE), TORAG_PLATELEGS(4751, RARE), VERAC_HELM(4753, RARE), VERAC_FLAIL(
														4755, RARE), VERAC_BRASSARD(4757, RARE), VERAC_SKIRT(4759,
																RARE), ABYSSAL_WHIP(4151, RARE), STAFF_OF_LIGHT(15486,
																		RARE), UNCUT_ONYX(6571, VERY_RARE), CRYSTAL_BOW(4212,
																				RARE), CRYSTAL_SHIELD(4224, RARE),

		ARMADYL_GODSWORD(11694, SUPER_RARE), BANDOS_GODSWORD(11696, SUPER_RARE), SARADOMIN_GODSWORD(11698,
				SUPER_RARE), ZAMORAK_GODSWORD(11700, SUPER_RARE), AMULET_OF_FURY(6585, VERY_RARE), SARADOMIN_SWORD(11730,
						SUPER_RARE), BANDOS_TASSETS(11726, SUPER_RARE), BANDOS_CHESTPLATE(11724,
								SUPER_RARE), ARMADYL_HELMET(11718, SUPER_RARE), ARMADYL_CHESTPLATE(11720,
										SUPER_RARE), ARMADYL_LEGS(11722, SUPER_RARE);
