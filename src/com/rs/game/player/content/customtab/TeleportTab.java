...
public class TeleportTab extends CustomTab {
	...
	private static int CITY_TELEPORTS = 0, SKILLING = 1, MONSTERS = 2, DUNGEONS = 3, BOSSES = 4, MINIGAMES = 5, WILDERNESS = 6,
			SKILLING_MINING = 13, SKILLING_SMITHING = 14, SKILLING_FISHING = 15, SKILLING_COOKING = 16,
	...
	public enum TeleportTabData {
		...
		MISCELLANIA("M", 22, CITY_TELEPORTS, "Miscellania"),
		...
		// FISHING LOCATIONS
		DRAYNOR_FISHING(3, SKILLING_FISHING, "Catherby Fishing"),
		...
		// AGILITY LOCATIONS
		BARBARIAN_COURSE(4, SKILLING_AGILITY, "Barbarian Agility Course"),

		// THIEVING LOCATIONS
		ARDOUGNE_STALLS(3, SKILLING_THIEVING, "Ardougne Stalls"),
		
		//HUNTER
		PUROPURO(3, SKILLING_HUNTER, "Puro-Puro"),
		...
		YAKS(4, MONSTERS, "Yaks"),

		OGRES(5, MONSTERS, "Ogres"),
		...
		GLACORS(4, BOSSES, "Glacors"),
		
		CORPOREAL_BEAST(5, BOSSES, "Corporeal Beast"),
		
		KALPHITE_QUEEN(6, BOSSES, "Kalphite Queen"),
		
		TORMENTED_DEMONS(7, BOSSES, "Tormented Demons"),
		
		QUEEN_BLACK_DRAGON(8, BOSSES, "Quen Black Dragon"),
		...
		WARRIORGUILD(6, MINIGAMES, "Warrior Guild"),

		DUELARENA(7, MINIGAMES, "Duel Arena"),

		CLANWARS(8, MINIGAMES, "Clan Wars"),

		DOMINION(9, MINIGAMES, "Dominion Tower"),
