...
public class MysteryBox {
	...
	public enum Rewards {
		...
		// JACK LANTERN MASK
																				...
																				ROBIN_HOOD_HAT(2581, RARE),
																				RANGER_BOOTS(2577, RARE),
																				GUTHIX_HALO(18744, COMMON),
																				SARADOMIN_HALO(18745, COMMON),
																				ZAMORAK_HALO(18746, COMMON),
																				AMULET_OF_FURY_OR(19335, RARE),
																				COINS(995, COMMON),
																				RANGE_BOOTS(10696, COMMON), 
																												
																																														
																												//profound
																				PROFOUND_DECORATIVE_PLATEBODY(18706, UNCOMMON),
																				PROFOUND_DECORATIVE_PLATELEGS(18707, UNCOMMON),
																				PROFOUND_DECORATIVE_HELM(18708, UNCOMMON),
																				PROFOUND_DECORATIVE_SHIELD(18709, UNCOMMON);
	...
	private static int getRewardAmount(Rewards reward) {
		switch (reward) {
		case COINS:
			return Utils.random(1000000, 50000000);
		default:
			return 1;
		}
	}
