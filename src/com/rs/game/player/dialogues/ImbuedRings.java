	...
	public void start() {
		...
		sendEntityDialogue(SEND_1_TEXT_CHAT,
				new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
						"To imbue rings you need, a ring to imbue, 50K Ressurge points and 5 million coins." },
				IS_NPC, npcId, 9827);
	}
	...
	public void run(int interfaceId, int componentId) {
		...
		if (stage == 1) {
			if (componentId == OPTION_1) {
				...
				} else if (player.getRessurgePoints() < 50000) {
					stage = 10;
					sendEntityDialogue(SEND_1_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
							"You need to have at least 50,000 Ressurge points." }, IS_NPC, npcId, 9827);
