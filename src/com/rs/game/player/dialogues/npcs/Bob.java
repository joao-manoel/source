...
public class Bob extends Dialogue {
	...
	private int getRepairPrice() {
		...
		for (Item item : player.getInventory().getItems().toArray()) {
			...
			if (isRepairable(item)) {
				...
				if(    item.getId() >= 20149 && item.getId() <= 20150//pernix cowl
					|| item.getId() >= 20153 && item.getId() <= 20154 //pernix body
					|| item.getId() >= 20157 && item.getId() <= 20158 //pernix chaps
					|| item.getId() >= 20161 && item.getId() <= 20162 //virtus mask
					|| item.getId() >= 20165 && item.getId() <= 20166 //virtus rope top
					|| item.getId() >= 20169 && item.getId() <= 20170 //virtus robe legs
					|| item.getId() >= 20137 && item.getId() <= 20138 //torva helm
					|| item.getId() >= 20141 && item.getId() <= 20142 //torva platebody
					|| item.getId() >= 20145 && item.getId() <= 20146 //torva platelegs
						) {
					price += 10000000;
				}else {
	...
	private int getRepairId(Item item) {
		//torva helm
		if(item.getId() >= 20137 && item.getId() <= 20138)
			return 20135;
		
		//torva platebody
		if(item.getId() >= 20141 && item.getId() <= 20142)
			return 20139;
		
		//torva platelegs
		if(item.getId() >= 20145 && item.getId() <= 20146)
			return 20143;
		
		//virtus mask
		if(item.getId() >= 20161 && item.getId() <= 20162)
			return 20159;
		
		//virtus robe top
		if(item.getId() >= 20165 && item.getId() <= 20166)
			return 20163;
		
		//virtus robe legs
		if(item.getId() >= 20169 && item.getId() <= 20170)
			return 20167;
		
		//pernix cowl
		if(item.getId() >= 20149 && item.getId() <= 20150)
			return 20147;
		
		//pernix body
		if(item.getId() >= 20153 && item.getId() <= 20154)
			return 20151;
		
		//pernix chaps
		if(item.getId() >= 20157 && item.getId() <= 20158)
			return 20155;
	...
	private boolean isRepairable(Item item) {
		if (item.getDefinitions().isNoted())
			return false;
		if(item.getId() >= 20149 && item.getId() <= 20150
				|| item.getId() >= 20153 && item.getId() <= 20154
				|| item.getId() >= 20157 && item.getId() <= 20158
				|| item.getId() >= 20161 && item.getId() <= 20162
				|| item.getId() >= 20165 && item.getId() <= 20166
				|| item.getId() >= 20169 && item.getId() <= 20170 //virtus robe legs
				|| item.getId() >= 20137 && item.getId() <= 20138 //torva helm
				|| item.getId() >= 20141 && item.getId() <= 20142
				|| item.getId() >= 20145 && item.getId() <= 20146
				) {
			return true;
		}else {
			try {
