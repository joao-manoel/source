	...
	public void run(int interfaceId, int componentId) {
		if (stage == 0) {
			...
			if (componentId == OPTION_1) {
				...
				stage = 25;
				sendOptionsDialogue("What aura would you like to buy?", "Vampyrism 15 Ruby points", "Penance (100k)",
			...
			if (componentId == OPTION_1) {
				if (player.getRessurgePoints() >= 50000) {
					if (player.getInventory().hasFreeSlots()) {
						stage = 50;
						sendPlayerDialogue(9827, "Thanks!");
						player.setRessurgePoints(player.getRessurgePoints() - 50000);
					...
					sendEntityDialogue(SEND_1_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
							"You need at least 50,000 ressurge points." }, IS_NPC, npcId, 9827);
				}
			} else if (componentId == OPTION_2) {
				if (player.getRessurgePoints() >= 100000) {
					if (player.getInventory().hasFreeSlots()) {
						stage = 50;
						sendPlayerDialogue(9827, "Thanks!");
					...
					stage = 50;
					sendEntityDialogue(SEND_1_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
							"You need at least 100,000 ressurge points." }, IS_NPC, npcId, 9827);
				}
			} else if (componentId == OPTION_3) {
				if (player.getRessurgePoints() >= 150000) {
					if (player.getInventory().hasFreeSlots()) {
						stage = 50;
						sendPlayerDialogue(9827, "Thanks!");
						player.setRessurgePoints(player.getRessurgePoints() - 150000);
					...
					stage = 50;
					sendEntityDialogue(SEND_1_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
							"You need at least 150,000 ressurge points." }, IS_NPC, npcId, 9827);
				}
			} else if (componentId == OPTION_4) {
				if (player.getRessurgePoints() >= 200000) {
					if (player.getInventory().hasFreeSlots()) {
						stage = 50;
						sendPlayerDialogue(9827, "Thanks!");
						player.setRessurgePoints(player.getRessurgePoints() - 200000);
					...
					stage = 50;
					sendEntityDialogue(SEND_1_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
							"You need at least 200,000 ressurge points." }, IS_NPC, npcId, 9827);
				}
			} else if (componentId == OPTION_5) {
				stage = 1;
				sendOptionsDialogue("What aura would you like to buy?", "Salvation Auras", "Corruption Auras",
			...
			if (componentId == OPTION_1) {
				if (player.getRubyPoints() >= 15) {
					if (player.getInventory().hasFreeSlots()) {
						stage = 50;
						sendPlayerDialogue(9827, "Thanks!");
						player.setRubyPoints(player.getRubyPoints() - 15);
					...
					stage = 50;
					sendEntityDialogue(SEND_1_TEXT_CHAT, new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
							"You need at least 15 Ruby points." }, IS_NPC, npcId, 9827);
				}
			} else if (componentId == OPTION_2) {
				if (player.getRessurgePoints() >= 100000) {
					if (player.getInventory().hasFreeSlots()) {
