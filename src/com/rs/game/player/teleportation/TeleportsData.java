...
public class TeleportsData {
	...
	public enum TeleportStore {
		...
		PUROPURO(new WorldTile(2421, 4444, 0)),
		
		MISCELLANIA(new WorldTile(2595, 3875, 0)),
		
		
		// MINING LOCATIONS
		ALKHARID_MINING(new WorldTile(3300, 3313, 0)),

		// SMITHING LOCATIONS
		ALKHARID_FURNACE(new WorldTile(3282, 3185, 0)),

		// FISHING LOCATIONS
		DRAYNOR_FISHING(new WorldTile(2834, 3436, 0)),

		// COOKING LOCATIONS
		CATHERBY_RANGE(new WorldTile(2816, 3438, 0)),

		// WOODCUTTING LOCATIONS
		CAMELOT_WOODCUTTING(new WorldTile(2723, 3484, 0)),

		// FARMING LOCATIONS
		CATHERBY_PATCHES(new WorldTile(2806, 3463, 0)),

		// AGILITY LOCATIONS
		GNOME_COURSE(new WorldTile(2474, 3438, 0)),

		// THIEVING LOCATIONS
		ARDOUGNE_STALLS(new WorldTile(2662, 3305, 0)),
		...
		BARBARIAN_COURSE(new WorldTile(2552, 3557, 0)),
		...
		GLACORS(new WorldTile(4180, 5726, 0)),
