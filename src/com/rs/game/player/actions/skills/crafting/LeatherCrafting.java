...
public class LeatherCrafting extends Action {
    ...
    public static final Animation CRAFT_ANIMATION = new Animation(1249);
    ...
    public static final int LEATHER[] = {1741, 1745, 2505, 2507, 2509, 24374};

    public static final int PRODUCTS[][] = {{1063, 1095, 1129}, {1065, 1099, 1135},
    ...
    public int processWithDelay(Player player) {
        ...
        player.getSkills().addXp(Skills.CRAFTING, data.getExperience() * 10);
        player.getPackets().sendGameMessage(
        ...
        if (Utils.getRandom(30) <= 3) {
            if (player.getInventory().containsItem(NEEDLE.getId(), 1))
