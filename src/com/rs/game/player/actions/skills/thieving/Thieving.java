...
public class Thieving {
	...
	public enum Stalls {
		VEGETABAL(4706, 2, new int[] { 1957, 1965, 1942, 1982, 1550 }, 1, 2, 10,
				34381), CAKE(34384, 1, new int[] { 1891, 1897,
						2309 }, 1, 2.5, 16,
				34381), CRAFTING(0, 5, new int[] { 1755, 1592, 1597 }, 1, 7, 16, 34381), MONKEY_FOOD(0, 5,
						...
						34381), MONKEY_GENERAL(0, 5, new int[] { 1931, 2347, 590 }, 1, 7, 16, 34381), TEA_STALL(0, 5,
								new int[] { 712 }, 1, 7, 16,
								34381), SILK_STALL(34383, 45, new int[] { 950 }, 1, 8, 94, 34381), WINE_STALL(14011, 22,
										new int[] { 1937, 1993, 1987, 1935, 7919 }, 1, 16, 27, 2046), SEED_STALL(7053,
												...
												30, 11, 10, 2047), FUR_STALL(34387, 35, new int[] { 6814, 958 }, 1, 15,
														36, 34381), FISH_STALL(4705, 42, new int[] { 331, 359, 377 }, 1,
																16, 42, 34381), CROSSBOW_STALL(0, 1,
																		new int[] { 9177, 9179, 9181, 9183, 9185 }, 1,
																		11, 52, 34381), SILVER_STALL(0, 50,
																				new int[] { 442 }, 1, 30, 54,
																				34381), SPICE_STALL(34386, 65,
																						new int[] { 2007 }, 1, 80, 81,
																						34381), MAGIC_STALL(0, 65,
																								new int[] { 556, 557,
																										554, 555, 563 },
																								30, 80, 100,
			...
			if (stall.getObjectId() == object.getId()) {
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						stop();
						/*
						 * World.spawnObjectTemporary(emptyStall, (int) (1500 *
						 * stall.getTime()));
						 */
					}
				}, 0, 0);
