...
public class Slayer {
	...
	public enum SlayerMaster implements Serializable {
		...
		EASY(1597, 40, 1, new int[] { 15, 50, 100 }, new int[] { 30, 50 }, SlayerTask.ABERRANT_SPECTRE,
				SlayerTask.ANKOU, SlayerTask.BASILISK, SlayerTask.BLOODVELD, SlayerTask.COCKATRICE, SlayerTask.CYCLOPS,
				SlayerTask.OGRE, SlayerTask.DUST_DEVIL, SlayerTask.EARTH_WARRIOR, SlayerTask.GREEN_DRAGON,
				SlayerTask.HILL_GIANT, SlayerTask.ICE_GIANT, SlayerTask.ICE_WARRIOR, SlayerTask.INFERNAL_MAGE,
				SlayerTask.JELLY, SlayerTask.PYREFIEND, SlayerTask.ROCKSLUG, SlayerTask.LESSER_DEMON,
				SlayerTask.MOSS_GIANT),

		MEDIUM(1598, 70, 30, new int[] { 30, 60, 120 }, new int[] { 30, 80 }, SlayerTask.ABERRANT_SPECTRE,
				...
				SlayerTask.INFERNAL_MAGE, SlayerTask.OGRE, SlayerTask.JELLY, SlayerTask.KALPHITE,
				SlayerTask.WALLASALKI),

		HARD(9085, 100, 70, new int[] { 50, 100, 150 }, new int[] { 30, 80 }, SlayerTask.ABYSSAL_DEMON,
				...
				SlayerTask.DAGANNOTH, SlayerTask.GARGOYLE, SlayerTask.ICE_STRYKEWYRM, SlayerTask.MUTATED_JADINKO_MALE),
		...
		BOSS(10000, 110, 90, new int[] { 75, 150, 225 }, new int[] { 5, 20 }, SlayerTask.CORPOREAL_BEAST,
				...
				SlayerTask.DAGANNOTH_KINGS, SlayerTask.TORMENTED_DEMON);
