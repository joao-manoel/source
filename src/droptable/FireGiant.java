...
public final class FireGiant extends MobRewardNodeBuilder {
	...
	public FireGiant() {
		super(new Object[] { "Fire giant", 1103 });
	}
	...
	public void populate(Player player) {
		...
		case -1:
		case COMMON:
			dissectNodeBatch(1, node("steel hatchet", 1), 
			...
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node("fire battlestaff", 1), 
			...
			break;
		case RARE:
			dissectNodeBatch(1, node("nature rune", 15), 
			...
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node("rune 2h sword", 1), 
